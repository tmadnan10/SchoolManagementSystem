			...
			<div class="wizard-container">
					...
					<ul class="nav nav-pills">
						<li class="active" style="width: 100%;">
							<a href="#st" data-toggle="tab" aria-expanded="true">Upload Seat Plan of an Upcoming Exam</a>
						</li>
					</ul>
					<div class="tab-content">
						<div class="tab-pane active" id="st">
              			<center>@if(count($exams) != 0) &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp{{$exams->exam_name}} is upcoming.....<br>Upload The Seat Plan @else No Upcoming Exam Pending You @endif </center>
                          	...
                          	@if(count($exams) != 0)
                          	{!! Form::open(array('class' => 'form-horizontal', 'url'=>'/seatplan','method'=>'POST', 'files'=>true)) !!}
