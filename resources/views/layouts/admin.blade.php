        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li class="snippets-index snippets-view snippets-add snippets-edit">
                    <a href="{{ url('/').'/addnew' }}"> <span class="glyphicon glyphicon-user"></span><font> Add New User </font></a>
                </li>
                <li class="themes-index themes-view themes-add">
                    <a href="{{url('/teacher_management')}}"> <span class="glyphicon glyphicon-briefcase"></span> <font> Teacher Management </font></a>
                </li>
                <li class="utilities-index utilities-view utilities-add">
                    <a href="{{url('admin/exam_management')}}"> <span class="glyphicon glyphicon-book"></span> <font>Examination Management </font></a>
                </li>
                <li class="utilities-index utilities-view utilities-add">
                    <a href="{{url('admin/club_management')}}"> <span class="glyphicon glyphicon-th-large"></span><font> Club Management </font></a>
                </li>
            </ul>
